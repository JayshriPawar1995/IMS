      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            <p className="text-sm text-gray-500 mb-2">Today is {currentDate}</p>
        ...
        <div>
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Tomorrow is a Holiday!</h4>
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Let us make a promise that we would not let the hard sacrifices of our brave freedom fighters go in
                    vain. We would work hard to make our country the best in the world. Happy Republic Day 2021!
                  </p>
                </div>
                <div className="flex items-center gap-3 pt-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Jan 26th, 2021 • 10:30 AM</p>
                  </div>
                </div>
              </div>
            </CardContent>
